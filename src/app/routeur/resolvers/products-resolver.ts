...
export const productResolver: ResolveFn<ProductModel[]> = (route, state) => {
  ...
  // "of" permet de créer un "faux flux de données asynchrone"
  // "delay" permet d'attendre 3sec avant de retourner l'information
  // -> on retourne donc la liste de produits après 3sc
